...
function firebaseListObservable(ref, _a) {
    ...
    return rxjs_operator_observeOn.observeOn.call(listObs, new angularfire2.FirebaseZoneScheduler(new _angular_core.NgZone({})));
}
...
function FirebaseObjectFactory(ref, _a) {
    ...
    return rxjs_operator_observeOn.observeOn.call(objectObservable, new angularfire2.FirebaseZoneScheduler(new _angular_core.NgZone({})));
}
